...
export const formalQuestions: Question[] = [
  ...
  },
  {
    ...
    dimension: "P",
    options: [
      option("A", "系统直接崩溃：疼痛或不适感强烈到需要马上离开，会开不下去了", 3, "P"),
      option("B", "弹出“内存不足”警告：有明显不适或经量感，需要分出一部分注意力处理", 2, "P"),
      option("C", "收到一条“静默通知”：有轻微感觉，但身体基本正常运转，不影响开会", 1, "P"),
      option("D", "已设置“免打扰模式”：几乎没有不适感，不处理也能继续开会", 0, "P")
    ]
  },
  {
    id: "P4",
